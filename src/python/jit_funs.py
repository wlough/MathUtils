...
#     #     cos_theta = np.sign(cos_theta) * epsilon
#     # if abs(sin_theta) < epsilon:
#     #     sin_theta = np.sign(sin_theta) * epsilon
#     # cos_theta_sqr = cos_theta * cos_theta
#     # sin_theta_sqr = sin_theta * sin_theta
#     # q1 = cos_theta ** (l - abs_m) * sin_theta ** (abs_m)
#     # log_q2 = (
...
#
# @njit
# def problem_angles_small_Ylm(l, m, theta, phi):
#     """
#     Spherical harmonic Ylm(l, m) at angles theta, phi. Works for small sin/cos(theta)
#
#     Args:
#         l (int): 0,1,2,...
#         m (int): -l,...,l
...
#     cos_theta = np.cos(theta)
#     sin_theta = np.sin(theta)
#     rlm = np.exp(1j * m * phi) / (2 * np.sqrt(np.pi))
#     if m > 0:
#         if m % 2 == 1:
#             rlm *= -1
#     log_qk = (
...
#
# @njit
# def real_part_problem_angles_small_Ylm(l, m, theta, phi):
#     abs_m = abs(m)
#     cos_theta = np.cos(theta)
#     sin_theta = np.sin(theta)
#     rlm = np.cos(m * phi) / (2 * np.sqrt(np.pi))
#     if m > 0:
#         if m % 2 == 1:
#             rlm *= -1
#     log_qk = (
...
#
# @njit
# def imag_part_problem_angles_small_Ylm(l, m, theta, phi):
#     abs_m = abs(m)
#     cos_theta = np.cos(theta)
#     sin_theta = np.sin(theta)
#     rlm = np.sin(m * phi) / (2 * np.sqrt(np.pi))
#     if m > 0:
#         if m % 2 == 1:
#             rlm *= -1
#     log_qk = (
...
#
# @njit
# def problem_angles_same_Ylm(l, m, theta, phi):
#     """
#     Spherical harmonic Ylm(l, m) at angles theta, phi. Works for arrays of angles.
#
#     Args:
...
#     #     - log_factorial(abs_m)
#     # )
#     # trig_term = cos_theta**l * tan_theta**abs_m
#     # sk = 1
#     # sum_Qk = sk * np.exp(log_qk) * trig_term
#     # minus_log4 = np.log(0.25)
#     # for k in range(1, 1 + int((l - abs_m) / 2)):
...
#     #         - np.log(k)
#     #     )
#     #     trig_term = cos_theta**l * tan_theta ** (abs_m + 2 * k)
#     #     sum_Qk += sk * np.exp(log_qk) * trig_term
#     #
#     #
#     #
...
#     # abs_m = abs(m)
#     # rlm = (
#     #     np.sign(cos_theta**l * tan_theta**abs_m)
#     #     * np.exp(1j * m * phi)
#     #     / (2 * np.sqrt(np.pi))
#     # )
#     # if m > 0:
...
#
# @njit
# def real_part_problem_angles_same_Ylm(l, m, theta, phi):
#     cos_theta = np.cos(theta)
#     tan_theta = np.tan(theta)
#     abs_cos_theta = abs(cos_theta)
#     abs_tan_theta = abs(tan_theta)
...
#
# @njit
# def imag_part_problem_angles_same_Ylm(l, m, theta, phi):
#     cos_theta = np.cos(theta)
#     tan_theta = np.tan(theta)
#     abs_cos_theta = abs(cos_theta)
#     abs_tan_theta = abs(tan_theta)
...
# def scalarsafeYlm(l, m, theta, phi):
#     """
#     Spherical harmonic Ylm(l, m) at angles theta, phi. Works for arrays of angles.
#
#     Args:
...
#         return problem_angles_small_Ylm(l, m, theta, phi)
#     if abs_sin_theta < epsilon:
#         return problem_angles_small_Ylm(l, m, theta, phi)
#     if abs(abs_cos_theta - abs_sin_theta) < epsilon:
#         return problem_angles_same_Ylm(l, m, theta, phi)
#     log_abs_cos_theta = np.log(abs_cos_theta)
#     log_abs_sin_theta = np.log(abs_sin_theta)
#     abs_m = abs(m)
#     rlm = (
#         np.sign(cos_theta ** (l - abs_m) * sin_theta**abs_m)
#         * np.exp(1j * m * phi)
#         / (2 * np.sqrt(np.pi))
#     )
#     if m > 0:
...
#
# @njit("f8(i8, i8, f8, f8)")
# def real_part_scalarsafeYlm(l, m, theta, phi):
#     cos_theta = np.cos(theta)
#     sin_theta = np.sin(theta)
#     abs_cos_theta = abs(cos_theta)
#     abs_sin_theta = abs(sin_theta)
#     epsilon = 1e-8
#     if abs_cos_theta < epsilon:
#         return real_part_problem_angles_small_Ylm(l, m, theta, phi)
#     if abs_sin_theta < epsilon:
#         return real_part_problem_angles_small_Ylm(l, m, theta, phi)
#     if abs(abs_cos_theta - abs_sin_theta) < epsilon:
#         return real_part_problem_angles_same_Ylm(l, m, theta, phi)
#     log_abs_cos_theta = np.log(abs_cos_theta)
#     log_abs_sin_theta = np.log(abs_sin_theta)
#     abs_m = abs(m)
#     rlm = (
...
#
# @njit("f8(i8, i8, f8, f8)")
# def imag_part_scalarsafeYlm(l, m, theta, phi):
#     cos_theta = np.cos(theta)
#     sin_theta = np.sin(theta)
#     abs_cos_theta = abs(cos_theta)
#     abs_sin_theta = abs(sin_theta)
#     epsilon = 1e-8
#     if abs_cos_theta < epsilon:
#         return imag_part_problem_angles_small_Ylm(l, m, theta, phi)
#     if abs_sin_theta < epsilon:
#         return imag_part_problem_angles_small_Ylm(l, m, theta, phi)
#     if abs(abs_cos_theta - abs_sin_theta) < epsilon:
#         return imag_part_problem_angles_same_Ylm(l, m, theta, phi)
#     log_abs_cos_theta = np.log(abs_cos_theta)
#     log_abs_sin_theta = np.log(abs_sin_theta)
#     abs_m = abs(m)
#     rlm = (
...
#     """
#     Ns = len(theta)
#     Y = np.zeros(Ns, dtype=np.complex128)
#     for s in range(Ns):
#         th = theta[s]
#         ph = phi[s]
#         Y[s] = scalarsafeYlm(l, m, th, ph)
#         # Y[s] = scalarYlm(l, m, th, ph)
#     return Y
#
#
# @njit("f8[:](i8, i8, f8[:], f8[:])")
# def real_part_Ylm(l, m, theta, phi):
#     Ns = len(theta)
#     Y = np.zeros(Ns)
#     for s in range(Ns):
#         th = theta[s]
#         ph = phi[s]
#         Y[s] = real_part_scalarsafeYlm(l, m, th, ph)
#     return Y
#
#
# @njit("f8[:](i8, i8, f8[:], f8[:])")
# def imag_part_Ylm(l, m, theta, phi):
#     Ns = len(theta)
#     Y = np.zeros(Ns)
#     for s in range(Ns):
#         th = theta[s]
#         ph = phi[s]
#         Y[s] = imag_part_scalarsafeYlm(l, m, th, ph)
#     return Y
#
#
# @njit("f8[:](i8, i8, f8[:], f8[:])")
# def real_form_Ylm(l, m, theta, phi):
#     if m < 0:
#         return np.sqrt(2) * (-1) ** m * imag_part_Ylm(l, abs(m), theta, phi)
#     elif m == 0:
#         return real_part_Ylm(l, m, theta, phi)
#     else:  # m >0
#         return np.sqrt(2) * (-1) ** m * real_part_Ylm(l, m, theta, phi)
#
#
# @njit
...
#
#     Returns:
#         real: value of spherical harmonic Ylm at angles theta, phi
#     """
#     abs_m = abs(m)
#     exp_itheta = np.exp(1j * theta)
#     cos_theta = exp_itheta.real
...
#             * np.sqrt(2)
#             * np.sin(abs_m * phi)
#             * (np.sqrt((2 * l + 1)) / (2 ** (abs_m + 1) * np.sqrt(np.pi)))
#         )
#     elif m > 0:
#         return (
#             val
...
#         )
#     else:  # m == 0
#         return val * (np.sqrt((2 * l + 1)) / (2 * np.sqrt(np.pi)))
#
