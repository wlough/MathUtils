...
from pymathutils.mesh.pyutils import SphericalHarmonicSurface, SphericalHarmonicSurface1
...
from pymathutils.mesh.pyutils import SphericalHarmonicSurface1
from src.python.mesh_viewer import MeshViewer
import numpy as np
...
#     },
# }
# mv = MeshViewer(s.spherical_mesh, **viewer_kwargs)
#
# mv.pv_plot(
#     show=True,
#     save=False,
